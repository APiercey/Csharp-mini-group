...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnlViewEmployees" runat="server">
        ...
        <asp:GridView ID="GridView2" runat="server" DataSourceID="sourceEmployees"
            AutoGenerateColumns="False" DataKeyNames="EmployeeID" AutoGenerateDeleteButton="False">           
        <Columns>
        ...
        <asp:SqlDataSource id="sourceEmployees" runat="server" 
            ...
            DeleteCommand="DELETE FROM EmployeeTerritories WHERE EmployeeID = @EmployeeID; UPDATE Orders SET EmployeeID = NULL WHERE EmployeeID = @EmployeeID; DELETE FROM Employees WHERE EmployeeID = @EmployeeID" >
